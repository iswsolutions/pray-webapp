...
export default function CuartoMisterioDoloroso() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          Fortaleza en la dificultad. Jesús agotado y con dolor cargó su cruz.
          Cuando pasamos por momentos difíciles, debemos enfrentarlos con
          valentía. Si confiamos en Dios durante nuestros problemas, Él nos da
          la fuerza y la paz necesarias para salir Adelante.
        </p>
      )}
    </article>
  );

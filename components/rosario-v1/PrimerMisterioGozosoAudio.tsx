...
const AUDIO_URL = "/api/audio/m-gozosos/primer-misterio";
...
export default function PrimerMisterioGozosoAudio() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          Un ángel le avisó a María el plan de Dios. María dijo que sí con
          confianza. Nosotros también debemos aprender a confiar en Dios, aunque
          tengamos dudas.
        </p>
      )}
        ...
        <button
          ...
          style={{
            ...
            boxShadow: audioState === "playing"
              ? "0 0 0 4px rgba(14,165,233,0.35), 0 0 16px rgba(14,165,233,0.5)"
              : undefined,

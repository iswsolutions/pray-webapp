...
export default function CuartoMisterioGlorioso() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          María, al final de su vida terrenal, es asunta al cielo en cuerpo y alma.
          Ella, que fue fiel a la voluntad de Dios desde la Anunciación hasta la Cruz,
          es llevada a la gloria celestial.
          Contemplamos a María como nuestra Madre y modelo, que intercede por nosotros desde el cielo.
        </p>
      )}
    </article>
  );

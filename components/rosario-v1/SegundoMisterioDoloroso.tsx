...
export default function SegundoMisterioDoloroso() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          Jesús sufrió dolor físico, pero lo aceptó en silencio y por amor a
          nosotros. Su sacrificio nos enseña a ser pacientes y a perdonar.
          Debemos estar agradecidos por su entrega y tratar de imitar su ejemplo
          de fortaleza en nuestra vida diaria.
        </p>
      )}
    </article>
  );

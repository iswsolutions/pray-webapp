...
const AUDIO_URL = "/api/audio/m-gozosos/cuarto-misterio";
...
export default function CuartoMisterioGozosoAudio() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          Un hombre llamado Simeón aceptó al niño Jesús como el Salvador que
          esperaba. Como Simeón, debemos aprender a ver a Dios en lo cotidiano.
          Podemos encontrar su presencia en los rostros de la gente que
          conocemos.
        </p>
      )}

...
export default function QuintoMisterioDoloroso() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          Esperanza y vida nueva. Jesús cumplió su misión para salvarnos. Su
          sacrificio cambió el dolor por esperanza y la muerte por vida eterna,
          abriéndonos a todos las puertas del cielo. Podemos vivir sabiendo que
          somos perdonados y que nuestra vida tiene un propósito especial.
        </p>
      )}
    </article>
  );

...
export default function QuintoMisterioGozoso() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          Jesús sorprendió a los maestros del templo con su gran inteligencia a
          la edad de doce años. Él nos enseñó que lo más importante es seguir el
          camino de Dios. Cuando nos sintamos perdidos o confundidos, podemos
          buscar a Jesús para encontrar la guía correcta. La idea es aprender a
          sentir su presencia.
        </p>
      )}
    </article>

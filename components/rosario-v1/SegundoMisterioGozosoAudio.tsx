...
const AUDIO_URL = "/api/audio/m-gozosos/segundo-misterio";
...
export default function SegundoMisterioGozosoAudio() {
    ...
    <article className="rounded-3xl border border-sky-100 bg-white/80 p-5 text-left shadow-lg shadow-sky-100 transition duration-200 hover:-translate-y-1 hover:border-sky-200 hover:bg-white sm:p-6 md:p-8">
      ...
      {open && (
        <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
          María visitó a su prima Isabel, nos enseña que es importante ayudar a
          los demás. Nosotros debemos tratar de dar consuelo y esperanza a las
          personas que conocemos, demostrando buenas acciones.
        </p>
      )}

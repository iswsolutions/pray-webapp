...
export default function MGozososCard({ isHighlighted }: { isHighlighted?: boolean }) {
  const audioRef = useRef<HTMLAudioElement | null>(null);
  const [audioState, setAudioState] = useState<AudioState>("idle");

  function getAudio(): HTMLAudioElement {
    if (!audioRef.current) {
      audioRef.current = new Audio("/api/audio/m-gozosos/mensaje");

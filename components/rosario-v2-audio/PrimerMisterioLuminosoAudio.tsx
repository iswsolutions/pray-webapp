...
const AUDIO_URL = "/api/audio/m-luminosos/primer-misterio";
const MEDITACION_URL = "/api/audio/m-luminosos/primer-misterio-meditacion";
...
export default function PrimerMisterioLuminosoAudio() {

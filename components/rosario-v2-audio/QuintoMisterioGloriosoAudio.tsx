...
const AUDIO_URL = "/api/audio/m-gloriosos/quinto-misterio";
const MEDITACION_URL = "/api/audio/m-gloriosos/quinto-misterio-meditacion";
...
export default function QuintoMisterioGloriosoAudio() {

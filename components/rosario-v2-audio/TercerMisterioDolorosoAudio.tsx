...
const AUDIO_URL = "/api/audio/m-dolorosos/tercer-misterio";
const MEDITACION_URL = "/api/audio/m-dolorosos/tercer-misterio-meditacion";
...
export default function TercerMisterioDolorosoAudio() {

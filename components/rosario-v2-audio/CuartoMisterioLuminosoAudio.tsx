...
const AUDIO_URL = "/api/audio/m-luminosos/cuarto-misterio";
const MEDITACION_URL = "/api/audio/m-luminosos/cuarto-misterio-meditacion";
...
export default function CuartoMisterioLuminosoAudio() {

...
const AUDIO_URL = "/api/audio/m-gloriosos/tercer-misterio";
const MEDITACION_URL = "/api/audio/m-gloriosos/tercer-misterio-meditacion";
...
export default function TercerMisterioGloriosoAudio() {

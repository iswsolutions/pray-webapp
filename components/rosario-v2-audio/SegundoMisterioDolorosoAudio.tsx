...
const AUDIO_URL = "/api/audio/m-dolorosos/segundo-misterio";
const MEDITACION_URL = "/api/audio/m-dolorosos/segundo-misterio-meditacion";
...
export default function SegundoMisterioDolorosoAudio() {

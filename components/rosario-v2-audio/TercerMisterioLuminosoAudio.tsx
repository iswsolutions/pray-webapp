...
const AUDIO_URL = "/api/audio/m-luminosos/tercer-misterio";
const MEDITACION_URL = "/api/audio/m-luminosos/tercer-misterio-meditacion";
...
export default function TercerMisterioLuminosoAudio() {

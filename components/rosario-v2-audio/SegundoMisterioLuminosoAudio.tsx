...
const AUDIO_URL = "/api/audio/m-luminosos/segundo-misterio";
const MEDITACION_URL = "/api/audio/m-luminosos/segundo-misterio-meditacion";
...
export default function SegundoMisterioLuminosoAudio() {

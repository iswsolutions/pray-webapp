...
const AUDIO_URL = "/api/audio/m-gloriosos/primer-misterio";
const MEDITACION_URL = "/api/audio/m-gloriosos/primer-misterio-meditacion";
...
export default function PrimerMisterioGloriosoAudio() {

...
const AUDIO_URL = "/api/audio/m-gloriosos/cuarto-misterio";
const MEDITACION_URL = "/api/audio/m-gloriosos/cuarto-misterio-meditacion";
...
export default function CuartoMisterioGloriosoAudio() {

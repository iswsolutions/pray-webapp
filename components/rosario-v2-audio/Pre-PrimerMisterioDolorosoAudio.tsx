...
const AUDIO_URL = "/api/audio/m-dolorosos/pre-primer-misterio";
...
export default function PrePrimerMisterioDolorosoAudio() {
  ...
  return (
    <article className="rounded-2xl border border-blue-100 bg-white/80 p-3 text-left shadow shadow-blue-100 transition duration-200 hover:-translate-y-1 hover:border-blue-200 hover:bg-white sm:p-4">
      ...
      <div className="mt-2 px-1">
        <input
          ...
          style={{
            background: `linear-gradient(to right, #0ea5e9 ${progress}%, #e0f2fe ${progress}%)`,
          }}
        />

...
const AUDIO_URL = "/api/audio/m-dolorosos/quinto-misterio";
const MEDITACION_URL = "/api/audio/m-dolorosos/quinto-misterio-meditacion";
...
export default function QuintoMisterioDolorosoAudio() {

...
const AUDIO_URL = "/api/audio/m-luminosos/quinto-misterio";
const MEDITACION_URL = "/api/audio/m-luminosos/quinto-misterio-meditacion";
...
export default function QuintoMisterioLuminosoAudio() {

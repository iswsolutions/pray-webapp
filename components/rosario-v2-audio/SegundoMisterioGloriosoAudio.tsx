...
const AUDIO_URL = "/api/audio/m-gloriosos/segundo-misterio";
const MEDITACION_URL = "/api/audio/m-gloriosos/segundo-misterio-meditacion";
...
export default function SegundoMisterioGloriosoAudio() {

...
const AUDIO_URL = "/api/audio/m-dolorosos/cuarto-misterio";
const MEDITACION_URL = "/api/audio/m-dolorosos/cuarto-misterio-meditacion";
...
export default function CuartoMisterioDolorosoAudio() {

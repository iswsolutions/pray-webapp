...
export default function PadreNuestroCardVideo() {
  ...
  return (
    <div
      className="relative w-full max-w-2xl mx-auto mb-6 rounded-3xl p-5 sm:p-8"
      style={{
    ...
    >
      ...
      {/* Video player */}
      <div className="relative -mx-5 sm:-mx-8 mb-4">
        <video
          ref={videoRef}
          src={URLS.padreNuestroVideo}
